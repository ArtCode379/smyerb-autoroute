...
private val onboardingPagesContent = listOf<OnboardingContent>(
    OnboardingContent(
        titleRes = R.string.vzbxv_page_1_title,
        descriptionRes = R.string.vzbxv_page_1_description,
        imageRes = R.drawable.vzbxv_ic_launcher_background,
    ),
    OnboardingContent(
        titleRes = R.string.vzbxv_page_2_title,
        descriptionRes = R.string.vzbxv_page_2_description,
        imageRes = R.drawable.vzbxv_ic_launcher_background,
    ),
    OnboardingContent(
        titleRes = R.string.vzbxv_page_2_title,
        descriptionRes = R.string.vzbxv_page_3_description,
        imageRes = R.drawable.vzbxv_ic_launcher_background,
    ),
)
